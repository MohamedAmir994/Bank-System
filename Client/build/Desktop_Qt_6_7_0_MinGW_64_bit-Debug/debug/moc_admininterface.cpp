...
Q_CONSTINIT const QMetaObject admininterface::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSadmininterfaceENDCLASS_t,
        ...
        // method 'on_createUserPb_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void admininterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->viewdbSignal(); break;
        case 1: _t->sendDb((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->on_createUserPb_clicked(); break;
        case 3: _t->on_viewdbpb_clicked(); break;
        case 4: _t->dbReceiveA((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &admininterface::viewdbSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (admininterface::*)(QString );
            if (_t _q_method = &admininterface::sendDb; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void admininterface::viewdbSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void admininterface::sendDb(QString _t1)
{
